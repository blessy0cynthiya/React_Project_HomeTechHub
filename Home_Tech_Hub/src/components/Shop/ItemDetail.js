                    ...
                    <div className='w-full md:w-2/5 flex flex-col divide-y-2 space-y-8'>
                        ...
                        <div className='flex-col space-y-5'>
                            ...
                            <div className='flex justify-around pt-4'>
                                ...
                                <p className='w-24 font-body text-gray-600 hover:text-gray-900'>1 Year Guarantee</p>
                                <p className='w-24 font-body text-gray-600 hover:text-gray-900'>24/7 Service</p>
                            </div>
                        </div>
                    </div>
                </div>
