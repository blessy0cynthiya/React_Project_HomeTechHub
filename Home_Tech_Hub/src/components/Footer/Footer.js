...
function Footer() {
    return(
        <footer className='bg-black-200 bg-opacity-40 w-screen pt-8 pb-28'>
            <div className='flex flex-col md:flex-row justify-center w-5/6 2xl:w-7/12 m-auto justify-between
                ...
                <div className='text-left md:text-left m-auto w-full md:w-0'>
                    <h1 className='font-display font-medium text-2xl text-gray-900'>Join the Home Tech Hub Family</h1>
                ...
                <div className='flex space-x-6 md:space-x-24'>
                    <div className='flex flex-col space-y-4'>
                        <Link to='/'>
                            <h1 className='font-display font-medium md:text-lg text-gray-900'>Home Tech Hub</h1>
                        </Link>
                    ...
                    <div className='flex flex-col space-y-4'>
                        ...
                        <Link to='/shop/airPurifying'>
                            <p className='font-body text-sm md:text-base text-gray-700'>Air Conditioner</p>
                        </Link>
                        <Link to='/shop/beginner'>
                            <p className='font-body text-sm md:text-base text-gray-700'>Washion Machine</p>
                        </Link>
                        <Link to='/shop/petFriendly'>
                            <p className='font-body text-sm md:text-base text-gray-700'>Mobile</p>
                        </Link>
                        <Link to='/shop/succulents'>
                            <p className='font-body text-sm md:text-base text-gray-700'>Laptop</p>
                        </Link>
                    </div>
                    <div className='flex flex-col space-y-4'>
