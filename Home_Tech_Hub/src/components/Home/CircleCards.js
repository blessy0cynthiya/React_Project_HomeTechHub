...
function CircleCards() {
    return(
        <div className='mb-20 w-full'>
            <h1 className='m-10 p-6 text-3xl md:text-5xl font-display text-gray-800 text-center'>Why You'll Love Home?</h1>
            ...
            space-y-12 md:space-y-0 text-center md:space-x-12 justify-around'>
                <li className='flex flex-col space-y-6 m-auto md:m-0'>
                    ...
                    <h2 className='text-2xl text-gray-800 font-display'> House with Love </h2>
                ...
                <li className='flex flex-col space-y-6 m-auto md:m-0'>
                    ...
                    <h2 className='text-2xl text-gray-800 font-display'>Fashion</h2>
